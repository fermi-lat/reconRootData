...
public:
    ...
    /// This method returns a "new" TkrVecNodeCompressed object allocated from the local pool
    TkrVecNodeCompressed* getNewTkrVecNodeCompressed();

    /// This method returns a "new" TkrTree object allocated from the local pool
    TkrTree*              getNewTkrTree();

    /// This method returns a "new" TkrTree object allocated from the local pool
    TkrTreeCompressed*    getNewTkrTreeCompressed();
...
private:
    ...
    /// Define a "pool" for TkrVecNodeCompressed objects and an iterator for accessing them
    std::list<TkrVecNodeCompressed>           m_tkrVecNodeCompressedPool;
    std::list<TkrVecNodeCompressed>::iterator m_tkrVecNodeCompressedPoolIdx;
    ...
    /// Define a "pool" for TkrTreeCompressed objects and an iterator for accessing them
    std::list<TkrTreeCompressed>              m_tkrTreeCompressedPool;
    std::list<TkrTreeCompressed>::iterator    m_tkrTreeCompressedPoolIdx;
