...
void TaggerCluster::Print(Option_t *option) const {
    ...
    cout << "Pos: " << m_baricenterPosition << " PulseHeight: " 
         << m_totalPulseHeight << " Eta: " << m_eta  << endl;
...
commonRootData::TaggerHit* TaggerCluster::addTaggerHit(UInt_t moduleId, 
      UInt_t layerId, UInt_t stripId, UInt_t pulseHgt, Bool_t isPedSub) {
    ...
    new(localCol[m_numTaggerHit]) commonRootData::TaggerHit(moduleId, layerId, stripId, pulseHgt, isPedSub);
