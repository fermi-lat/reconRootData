#ifndef ROOT_ACDKTRASSOC_H
#define ROOT_ACDKTRASSOC_H
...
class AcdTkrAssoc : public TObject {
...
public:
  ...
  /// Copy constructor
  AcdTkrAssoc(const AcdTkrAssoc& params);

  /// Assignment operator
  AcdTkrAssoc& operator=(const AcdTkrAssoc& params);
  ...
  Bool_t CompareInRange( const AcdTkrAssoc&, const std::string & name = "" ) const ; // for tests   
