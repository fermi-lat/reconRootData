...
public:
    ...
    inline Double_t   getAddedRadLen()  const {return m_radlen;}
    inline Double_t   getTkr1ArcLen()   const {return m_arcLen1;}
    inline Double_t   getTkr2ArcLen()   const {return m_arcLen2;}
    inline Double_t   getDOCA()         const {return m_doca;}
    ...
    inline void setEnergy(Double_t x)                  {m_energy     = x;}
    inline void setChiSquare(Double_t x)               {m_chiSquare  = x;}
    inline void setQuality(Double_t x)                 {m_quality    = x;}
    inline void setAddedRadLen(Double_t x)             {m_radlen     = x;}
    inline void setTkr1ArcLen(Double_t x)              {m_arcLen1    = x;}
    inline void setTkr2ArcLen(Double_t x)              {m_arcLen2    = x;}
    inline void setDOCA(Double_t x)                    {m_doca       = x;}
