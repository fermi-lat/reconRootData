...
%ROOT_PATH%\bin\rootcint -f reconRootDataCint.cxx -c -I%DIGIROOTDATAROOT% CalCluster.h CalRecon.h CalRangeRecData.h CalXtalRecData.h ReconEvent.h TkrCandHit.h TkrCandTrack.h TkrCovMat.h TkrFitHit.h TkrHitPlane.h TkrParams.h TkrRecon.h TkrTrack.h TkrVertex.h ReconLinkDef.h
